...
load "/home/himanshu/thesis_codes/ExChap4/Q_fnonsplit/loc_func.m";
...
almost_real := function(c)
  if AbsoluteValue(Imaginary(c)) lt 10^(-15) then return true; else return false; end if;
end function;
...
compctp := function(f, C, SGtoA, J,elt1,elt2)
good_elts := [elt1,elt2];
...
ctpval := realctp(WPts, f, globmat, S, SGtoA, elt1, elt2);
